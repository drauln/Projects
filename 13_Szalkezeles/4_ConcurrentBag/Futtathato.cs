...
namespace Szalkezeles_Concurrent_Bag
{
    class Futtathato
    {
        static ConcurrentBag<Szemely> concurrentBag = new ConcurrentBag<Szemely>();
        ...
        static void Main(string[] args)
        {
            ...
            void Segitseg2()
            {
                for (int i = 0; i < elemszam; i++)
                {
                    concurrentBag.TryTake(out Szemely valami);
