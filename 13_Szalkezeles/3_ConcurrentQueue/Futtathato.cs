...
namespace Szalkezeles_Concurrent_Queue
{
    class Futtathato
    {
        static ConcurrentQueue<Szemely> concurrentSor = new ConcurrentQueue<Szemely>();
        ...
        static void Main(string[] args)
        {
            ...
            void Segitseg2()
            {
                for (int i = 0; i < elemszam; i++)
                {
                    concurrentSor.TryDequeue(out Szemely valami);
