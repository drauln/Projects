...
namespace Szoveges_fajl
{
    class Futtathato
    {
        static void Main(string[] args)
        {
            ...
            StreamWriter adatfolyamIras = new StreamWriter(fajlNev, false, Encoding.UTF8);

            adatfolyamIras.WriteLine(ember[0]);
            
            adatfolyamIras.Close();
            
            StreamReader adatfolyamOlvasas = new StreamReader(fajlNev);

            Console.WriteLine(adatfolyamOlvasas.ReadLine());
            
            adatfolyamOlvasas.Close();
