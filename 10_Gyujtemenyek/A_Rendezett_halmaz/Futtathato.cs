...
namespace A_Rendezett_halmaz
{
    class Futtathato
    {
        static void Main(string[] args)
        {
            ...
            // RendezettHalmaz használata (fizetés szerint)
            SortedSet<Szemely> rendezettHalmaz = new SortedSet<Szemely>(ember);
            
            foreach (object elem in rendezettHalmaz)
            {
                Console.WriteLine("Halmaz adatok: " + elem);
            }
