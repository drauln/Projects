...
namespace Tipusos_verem
{
    class Futtathato
    {
        static void Main(string[] args)
        {
            ...
            //Verem használata
            Stack<Szemely> verem = new Stack<Szemely>();
            Stack<Szemely> masikVerem = new Stack<Szemely>();
            ...
            for (int i = 0; i < elemszam; i++)
            {
                masikVerem.Push(verem.Peek());
                Console.WriteLine("Legfelső elem: " + verem.Pop());
            }
