...
namespace Varakozo_sor
{
    class Futtathato
    {
        static void Main(string[] args)
        {
            ...
            //VárakozóSor
            Queue<Szemely> sor = new Queue<Szemely>();
            
            for (int i = 0; i < elemszam; i++)
            {
                sor.Enqueue(ember[i]);
            }
            Console.WriteLine("Első elem a sorban: \n" + sor.Dequeue());
            Console.WriteLine("Második elem a sorban: \n" + sor.Dequeue());
            Console.WriteLine("Harmadik elem a sorban: \n" + sor.Dequeue());
